package tests.TestsBrokerViews;
...
public class ProDarkEn extends BaseTest {
    ...
    private BrokerViews brokerViews;
    ...
    public void demoAccountRegistrationTest(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Demo account is successfully registered - " + regulation + " regulation - Broker Views");
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,TestData.generateEmail(),countryCode,brokerViews.selectPhoneNumber(regulation));
    ...
    public void alreadyRegisteredEmailAddressTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Already registered email address - " + regulation + " regulation - Broker Views");
        Allure.step("Redirected to the page url");
        String email = TestData.generateEmail();
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        readyFortrade.assertURL(TestData.appUrl);
        openUrl(baseUrl);
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        brokerViews.assertErrMsgForAlreadyRegisteredAccount();
    }
    ...
    public void nonValidDataTest(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Non valid data - " + regulation + " regulation - Broker Views");
        Allure.step("Redirected to the page url");
        brokerViews.registerDemoAccount("123","574","abcd134324",countryCode,"abc8798");
        brokerViews.assertFirstStepErrorMessage(FirstStepField.ALL);
    }
    ...
    public void alreadyRegisteredPhoneNumberTest(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Already registered phone number - " + regulation + " regulation - Broker Views");
        Allure.step("Redirected to the page url");
        String phoneNumber = brokerViews.selectPhoneNumber(regulation);
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,TestData.generateEmail(),countryCode,phoneNumber);
        readyFortrade.assertURL(TestData.appUrl);
        openUrl(baseUrl);
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,TestData.generateEmail(),countryCode,phoneNumber);
        brokerViews.assertErrMsgForAlreadyRegisteredAccount();
    ...
    public void alreadyRegisteredEmailAndPhoneTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Already registered email address and phone number - " + regulation + " regulation - Broker Views");
        Allure.step("Redirected to the page url");
        String email = TestData.generateEmail();
        String phone = brokerViews.selectPhoneNumber(regulation);
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,phone);
        readyFortrade.assertURL(TestData.appUrl);
        openUrl(baseUrl);
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,phone);
        brokerViews.assertErrMsgForAlreadyRegisteredAccount();
    ...
    public void emptyDataRegistrationTest(String regulation){
        ScreenshotUtil.setCustomName("Unsuccessfully account registration with empty data - " + regulation + " regulation - Broker Views");
        Allure.step("Redirected to the page url");
        brokerViews.clickGetStartedBtn();
        brokerViews.assertFirstStepErrorMessage(FirstStepField.FIRST_NAME);
    }
    ...
    public void verifyErrorMessageForFirstNameTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for First Name - " + regulation + " regulation - Broker Views");
        Allure.step("Verified error message and border color for First Name field");
        ElementActions.type(brokerViews.firstName,"123", "first name");
        brokerViews.assertFirstStepErrorMessage(FirstStepField.FIRST_NAME);
    }
    ...
    public void verifyErrorMessageForLastNameTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for Last Name - " + regulation + " regulation - Broker Views");
        Allure.step("Verified error message and border color for Last Name field");
        ElementActions.type(brokerViews.lastName,"456", "last name");
        ElementActions.click(brokerViews.email, "email");
        brokerViews.assertFirstStepErrorMessage(FirstStepField.LAST_NAME);
    }
    ...
    public void verifyErrorMessageForEmailTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for Email - " + regulation + " regulation - Broker Views");
        Allure.step("Verified error message and border color for Email field");
        ElementActions.type(brokerViews.email,"dsv124234/=", "email");
        brokerViews.assertFirstStepErrorMessage(FirstStepField.EMAIL);
    }
    ...
    public void verifyErrorMessageForPhoneTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for Phone - " + regulation + " regulation - Broker Views");
        Allure.step("Verified error message and border color for Phone field");
        brokerViews.insertPhoneNumber("0034334424558200");
        brokerViews.assertFirstStepErrorMessage(FirstStepField.PHONE);
    }
    ...
    public void sameFNameAndLNameTest(String regulation) {
        ScreenshotUtil.setCustomName("Your first name must be different from your last name - " + regulation + " regulation - Broker Views");
        Allure.step("Check for error message for the same first and last name.");
        brokerViews.insertFirstName("Test");
        brokerViews.insertLastName("Test");
        ElementActions.click(brokerViews.email, "email address");
        brokerViews.assertFirstStepErrorMessage(FirstStepField.SAME_FULL_NAME);
    }
    ...
    public void sameLNameAndFNameTest(String regulation) {
        ScreenshotUtil.setCustomName("Your last name must be different from your first name - " + regulation + " regulation - Broker Views");
    ...
    public void checkHeaderPrivacyPolicyLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Header privacy policy link - " + regulation + " regulation - Broker Views");
        Allure.step("Left click on the header privacy policy link.");
        brokerViews.checkLinksWithLeftClick(brokerViews.headerPrivacyPolicyLink, "header privacy policy link", brokerViews.headerPrivacyPolicyUrl(regulation));
    }
    ...
    public void checkHeaderPrivacyPolicyLinkWithRightClickTest(String regulation){
        ...
        brokerViews.checkLinksWithRightClick(brokerViews.headerPrivacyPolicyLink, "header privacy policy link", brokerViews.headerPrivacyPolicyUrl(regulation));
    }
    ...
    public void checkHeaderTermsAndConditionsLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Header terms and conditions link - " + regulation + " regulation - Broker Views");
        Allure.step("Left click on the terms and conditions link.");
        brokerViews.checkLinksWithLeftClick(brokerViews.getTermsAndConditionsLink(regulation), "header terms and conditions link", brokerViews.headerTermsAndConditionsUrl(regulation));
    }
    ...
    public void checkHeaderTermsAndConditionsLinkWithRightClickTest(String regulation){
        ...
        brokerViews.checkLinksWithRightClick(brokerViews.getTermsAndConditionsLink(regulation), "header terms and conditions link", brokerViews.headerTermsAndConditionsUrl(regulation));
    }
    ...
    public void checkClickHereLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Click here link - " + regulation + " regulation - Broker Views");
        Allure.step("Left click on the click here link.");
        brokerViews.checkLinksWithLeftClick(brokerViews.clickHereLink, "click here link", TestData.clickHereUrl);
    }
    ...
    public void checkClickHereLinkWithRightClickTest(){
        ...
        brokerViews.checkLinksWithRightClick(brokerViews.clickHereLink, "header terms and conditions link", TestData.clickHereUrl);
    }
    ...
    public void checkAlreadyHaveAnAccountLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Already have an account link - " + regulation + " regulation - Broker Views");
        Allure.step("Left click on the already have an account link.");
        brokerViews.checkLinksWithLeftClick(brokerViews.alreadyHaveAnAccountLink, "already have an account link", TestData.alreadyHaveAnAccountUrl);
    }
    ...
    public void checkAlreadyHaveAnAccountLinkWithRightClickTest(){
        ...
        brokerViews.checkLinksWithRightClick(brokerViews.alreadyHaveAnAccountLink, "already have an account link", TestData.alreadyHaveAnAccountUrl);
    }
    ...
    public void checkContactUsLinkTest(String regulation){
        ScreenshotUtil.setCustomName("Contact Us link - " + regulation + " regulation - Broker Views");
        Allure.step("Left click on the contact us link.");
        brokerViews.checkMailLinks(brokerViews.contactUsLink, "href", TestData.contactUsUrl);
    }
    ...
    public void checkAccountRegulationTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Account regulation in CRM - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        readyFortrade.assertURL(TestData.appUrl);
    ...
    public void checkAccountDetailsInCrmTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Account details in CRM - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        readyFortrade.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email,TestData.firstName + " " + TestData.lastName,regulation);
    ...
    public void checkTagsInCrmTest(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Marketing tags - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        ...
        brokerViews.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation),
    ...
    public void checkLinkIDPCWindows(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Link ID tag contains the 'PC_windows' value - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl);
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
    ...
    public void emailIsReceived(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Email is received successfully - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
    ...
    public void iDidntReceiveTheCodeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("I didn't received the code link - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=sms-age-annual-saving-knowledge-plang:all");
        brokerViews.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        brokerViews.checkIDidntReceiveTheCodeLink();
    }
    ...
    public void wrongCodeCannotBeSubmittedTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Wrong code cannot be submitted - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=sms-age-annual-saving-knowledge-plang:all");
        brokerViews.fillTheFormOnTheSecondStepWithWrongSmsCode(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation),
                "25_34_age", "15000_50000_annual", "50000_100000_savings", "knowledge_of_trading_all_the_above","lang_EN",
                "1", "1", "1", "1");
        brokerViews.assertErrorMessageForWrongSmsCode();
    }
    ...
    public void editPencilButtonTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Edit pencil button redirects to the first step - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=sms-age-annual-saving-knowledge-plang:all");
        brokerViews.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        brokerViews.checkEditPencilButton();
    }
    ...
    public void redirectionToTheSecondStepAgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (age) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        brokerViews.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        WaitUtil.waitForVisible(brokerViews.age);
        Assert.assertTrue(brokerViews.age.isDisplayed());
    }
    ...
    public void registeredAgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (age) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "25_34_age", SecondStepField.AGE);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForAgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (age) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        brokerViews.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "25_34_age", "-99", SecondStepField.AGE);
        brokerViews.assertSecondStepErrorMessage(SecondStepField.AGE);
    }
    ...
    public void ageParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (age) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "25_34_age", SecondStepField.AGE);
    ...
    public void smsVerificationAgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (age) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "25_34_age", SecondStepField.AGE);
    ...
    public void redirectionToTheSecondStepAnnualTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (annual) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        brokerViews.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        WaitUtil.waitForVisible(brokerViews.annual);
        Assert.assertTrue(brokerViews.annual.isDisplayed());
    }
    ...
    public void registeredAnnualParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (annual) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "15000_50000_annual", SecondStepField.ANNUAL);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForAnnualParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (annual) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        brokerViews.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "15000_50000_annual", "-99", SecondStepField.ANNUAL);
        brokerViews.assertSecondStepErrorMessage(SecondStepField.ANNUAL);
    }
    ...
    public void annualParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (annual) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "15000_50000_annual", SecondStepField.ANNUAL);
    ...
    public void smsVerificationAnnualTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (annual) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "15000_50000_annual", SecondStepField.ANNUAL);
    ...
    public void redirectionToTheSecondStepSavingTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (saving) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        brokerViews.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        WaitUtil.waitForVisible(brokerViews.saving);
        Assert.assertTrue(brokerViews.saving.isDisplayed());
    }
    ...
    public void registeredSavingParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (saving) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "50000_100000_savings", SecondStepField.SAVING);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForSavingParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (saving) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        brokerViews.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "50000_100000_savings", "-99", SecondStepField.SAVING);
        brokerViews.assertSecondStepErrorMessage(SecondStepField.SAVING);
    }
    ...
    public void savingParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (saving) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "50000_100000_savings", SecondStepField.SAVING);
    ...
    public void smsVerificationSavingTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (saving) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "50000_100000_savings", SecondStepField.SAVING);
    ...
    public void redirectionToTheSecondStepKnowledgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (knowledge) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        brokerViews.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        WaitUtil.waitForVisible(brokerViews.knowledge);
        Assert.assertTrue(brokerViews.knowledge.isDisplayed());
    }
    ...
    public void registeredKnowledgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (knowledge) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", SecondStepField.KNOWLEDGE);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForKnowledgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (knowledge) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        brokerViews.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", "-99", SecondStepField.KNOWLEDGE);
        brokerViews.assertSecondStepErrorMessage(SecondStepField.KNOWLEDGE);
    }
    ...
    public void knowledgeParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (knowledge) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", SecondStepField.KNOWLEDGE);
    ...
    public void smsVerificationKnowledgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (knowledge) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", SecondStepField.KNOWLEDGE);
    ...
    public void redirectionToTheSecondStepLanguageTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (language) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        brokerViews.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
        WaitUtil.waitForVisible(brokerViews.language);
        Assert.assertTrue(brokerViews.language.isDisplayed());
    }
    ...
    public void registeredLanguageParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (language) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "lang_EN", SecondStepField.LANGUAGE);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForLanguageParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (language) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        brokerViews.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "lang_EN", "-99", SecondStepField.LANGUAGE);
        brokerViews.assertSecondStepErrorMessage(SecondStepField.LANGUAGE);
    }
    ...
    public void languageParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (language) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation), "lang_EN", SecondStepField.LANGUAGE);
    ...
    public void smsVerificationLanguageTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (language) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        brokerViews.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode, brokerViews.selectPhoneNumber(regulation), "lang_EN", SecondStepField.LANGUAGE);
    ...
    public void nonValidParameterInTheUrlTest(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Demo account is successfully registered with wrong parameters in the URL - " + regulation + " regulation - Broker Views");
    ...
    public void noDataOnTheSecondStepTest(String regulation,String countryCode) {
        ScreenshotUtil.setCustomName("Error messages (all parameters) - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age-annual-saving-knowledge-plang:all");
        brokerViews.fillTheFormOnTheSecondStepWithWrongData(TestData.firstName, TestData.lastName, email, countryCode, brokerViews.selectPhoneNumber(regulation), "25_34_age", "15000_50000_annual", "50000_100000_savings",
                "knowledge_of_trading_all_the_above", "lang_EN");
        brokerViews.assertSecondStepErrorMessage(SecondStepField.ALL);
    }
    ...
    public void dummyLeadRegistration(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Dummy - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        ...
        brokerViews.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
                brokerViews.selectPhoneNumber(regulation), "25_34_age", "50000_100000_annual", "50000_100000_savings",
                "knowledge_of_trading_all_the_above","lang_EN");
        readyFortrade.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email,TestData.fullName,regulation);
    ...
    public void dummy_Lead_Registration(String regulation,String countryCode) throws InterruptedException {
        ...
        brokerViews.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
                brokerViews.selectPhoneNumber(regulation), "25_34_age", "15000_50000_annual", "50000_100000_savings",
                "knowledge_of_trading_all_the_above","lang_EN");
        readyFortrade.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email,TestData.fullName,regulation);
        crmPage.checkCustomTag("Dummy");
    ...
    public void invalidLeadRegistration(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom tag - Invalid - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        ...
        brokerViews.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
                brokerViews.selectPhoneNumber(regulation), "45_54_age", "15000_50000_annual", "100000_250000_savings",
    ...
    public void emptyLeadRegistration(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Empty - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
    ...
    public void deviceIsSameAsParameter(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Dummy - device - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void nonValidParameterSyntax(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Invalid - device - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void deviceIsNotSameAsParameter(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Empty - device - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void deviceParameterContainsNonValidValue(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - non valid device value - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkingTheCustomTag(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 20-3-Custom Tag is empty - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        openUrl(baseUrl + "&fts=age-annual-saving-knowledge-plang:all");
        brokerViews.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
    ...
    public void checkLanguageFieldContainsExpectedValue(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Language field in the CRM contains expected (FR) value - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String expectedLanguage = brokerViews.selectExpectedLanguage(regulation);
    ...
    public void checkLanguageFieldContainsDefaultValue(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Language field in the CRM contains default (EN) value - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void dummypParameter(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 23-1-Custom tag-DummyP value - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void dummyParameter(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 23-2-Custom tag - Dummy value - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void parameterDummy(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 23-3-Custom tag - Dummy value - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void customTagContainsDummy(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-1-Custom tag field - dummy - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void customTagContainsDummyValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-2-Custom tag field - dummy - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void customTagContainsEmpty(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-3-Custom tag field - empty - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void customTagContainsEmptyValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-4-Custom tag field - empty - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkNumberIplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-1-Link Id tag field - {number}_IPL - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkMissingTag1IplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-2-Link Id tag field - missingTag1_IPL - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkMissingCidIplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-3-Link Id tag field - missingCID_IPL - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkDivByZeroIplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-4-Link Id tag field - divByZero_IPL - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkNoneUsdValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 26-2-Link Id tag field - None-usd - " + regulation + " regulation - Broker Views");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        openUrl(baseUrl);
        brokerViews.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,brokerViews.selectPhoneNumber(regulation));
