...
public class KapitalRSPage extends BasePage {
    ...
    @FindBy(xpath = "//div[@class='formGrid']//a[contains(@href,'fortrade-ltd/politika-o-zastiti-privatnosti')]")
    public WebElement headerPrivacyPolicyLink;

    @FindBy(xpath = "//div[@class='formGrid']//a[contains(@href,'fortrade-ltd/pravila-i-uslovi')]")
    ...
    @FindBy(xpath = "//div[@class='formGrid']//a[contains(@href,'https://pro.kapitalrs.com/?lang=')]")
    public WebElement alreadyHaveAnAccountLink;

    @FindBy(xpath = "//div[@class='formGrid']//a[contains(@href,'mailto:podrska@kapitalrs.com?subject')]")
    ...
    @FindBy(xpath = "//div[contains(@class, 'container')]//a[contains(@href, 'fortrade-ltd/politika-o-zastiti-privatnosti')]")
    ...
    public String selectExpectedLanguage(){
