...
import core.pages.FortradeRPage;
...
public class ProDarkMk extends BaseTest {
    ...
    @Test(description = "TC 1.7. Verify the CFD text is not displayed on the landing page")
    @Parameters({"regulation"})
    public void verifyCFDTextIsNotDisplayed(String regulation){
        ScreenshotUtil.setCustomName("CFD text is not displayed on the page - " + regulation + " regulation - FortradeR");
    ...
    public void demoAccountRegistrationTest(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Demo account is successfully registered - " + regulation + " regulation - FortradeR");
        fortradeRPage.registerDemoAccount(TestData.firstName,TestData.lastName,TestData.generateEmail(),countryCode,fortradeRPage.selectPhoneNumber(regulation));
    ...
    public void alreadyRegisteredEmailAddressTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Already registered email address - " + regulation + " regulation - FortradeR");
        Allure.step("Redirected to the page url");
        String email = TestData.generateEmail();
        fortradeRPage.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
        readyFortrade.assertURL(TestData.appUrl);
        openUrl(baseUrl);
        fortradeRPage.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
    ...
    public void nonValidDataTest(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Non valid data - " + regulation + " regulation - FortradeR");
        Allure.step("Redirected to the page url");
        fortradeRPage.registerDemoAccount("123","574","abcd134324",countryCode,"abc8798");
        fortradeRPage.assertFirstStepErrorMessage(FirstStepField.ALL);
    }
    ...
    public void alreadyRegisteredPhoneNumberTest(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Already registered phone number - " + regulation + " regulation - FortradeR");
        Allure.step("Redirected to the page url");
        String phoneNumber = fortradeRPage.selectPhoneNumber(regulation);
    ...
    public void alreadyRegisteredEmailAndPhoneTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Already registered email address and phone number - " + regulation + " regulation - FortradeR");
        Allure.step("Redirected to the page url");
        String email = TestData.generateEmail();
        String phone = fortradeRPage.selectPhoneNumber(regulation);
    ...
    public void emptyDataRegistrationTest(String regulation){
        ScreenshotUtil.setCustomName("Unsuccessfully account registration with empty data - " + regulation + " regulation - FortradeR");
        Allure.step("Redirected to the page url");
        fortradeRPage.clickGetStartedBtn();
        fortradeRPage.assertFirstStepErrorMessage(FirstStepField.FIRST_NAME);
    }
    ...
    public void verifyErrorMessageForFirstNameTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for First Name - " + regulation + " regulation - FortradeR");
    ...
    public void verifyErrorMessageForLastNameTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for Last Name - " + regulation + " regulation - FortradeR");
        ...
        ElementActions.click(fortradeRPage.email, "email");
        fortradeRPage.assertFirstStepErrorMessage(FirstStepField.LAST_NAME);
    }
    ...
    public void verifyErrorMessageForEmailTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for Email - " + regulation + " regulation - FortradeR");
        ...
        fortradeRPage.assertFirstStepErrorMessage(FirstStepField.EMAIL);
    }
    ...
    public void verifyErrorMessageForPhoneTest(String regulation){
        ScreenshotUtil.setCustomName("Error message and border color are displayed for Phone - " + regulation + " regulation - FortradeR");
        Allure.step("Verified error message and border color for Phone field");
        fortradeRPage.insertPhoneNumber("0034334424558200");
        fortradeRPage.assertFirstStepErrorMessage(FirstStepField.PHONE);
    }
    ...
    public void sameFNameAndLNameTest(String regulation) {
        ScreenshotUtil.setCustomName("Your first name must be different from your last name - " + regulation + " regulation - FortradeR");
        ...
        fortradeRPage.assertFirstStepErrorMessage(FirstStepField.SAME_FULL_NAME);
    }
    ...
    public void sameLNameAndFNameTest(String regulation) {
        ScreenshotUtil.setCustomName("Your last name must be different from your first name - " + regulation + " regulation - FortradeR");
    ...
    public void checkHeaderPrivacyPolicyLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Header privacy policy link - " + regulation + " regulation - FortradeR");
        Allure.step("Left click on the header privacy policy link.");
        fortradeRPage.checkLinksWithLeftClick(fortradeRPage.headerPrivacyPolicyLink, "header privacy policy link", fortradeRPage.headerPrivacyPolicyUrl(regulation));
    }
    ...
    public void checkHeaderPrivacyPolicyLinkWithRightClickTest(String regulation){
        ...
        fortradeRPage.checkLinksWithRightClick(fortradeRPage.headerPrivacyPolicyLink, "header privacy policy link", fortradeRPage.headerPrivacyPolicyUrl(regulation));
    }
    ...
    public void checkHeaderTermsAndConditionsLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Header terms and conditions link - " + regulation + " regulation - FortradeR");
        Allure.step("Left click on the terms and conditions link.");
        fortradeRPage.checkLinksWithLeftClick(fortradeRPage.getTermsAndConditionsLink(regulation), "header terms and conditions link", fortradeRPage.headerTermsAndConditionsUrl(regulation));
    }
    ...
    public void checkHeaderTermsAndConditionsLinkWithRightClickTest(String regulation){
        ...
        fortradeRPage.checkLinksWithRightClick(fortradeRPage.getTermsAndConditionsLink(regulation), "header terms and conditions link", fortradeRPage.headerTermsAndConditionsUrl(regulation));
    }
    ...
    public void checkClickHereLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Click here link - " + regulation + " regulation - FortradeR");
        Allure.step("Left click on the click here link.");
        fortradeRPage.checkLinksWithLeftClick(fortradeRPage.clickHereLink, "click here link", TestData.clickHereUrl);
    }
    ...
    public void checkClickHereLinkWithRightClickTest(){
        ...
        fortradeRPage.checkLinksWithRightClick(fortradeRPage.clickHereLink, "header terms and conditions link", TestData.clickHereUrl);
    }
    ...
    public void checkAlreadyHaveAnAccountLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Already have an account link - " + regulation + " regulation - FortradeR");
    ...
    public void checkContactUsLinkTest(String regulation){
        ScreenshotUtil.setCustomName("Contact Us link - " + regulation + " regulation - FortradeR");
    ...
    public void checkSupportLinkTest(String regulation){
        ScreenshotUtil.setCustomName("Support link - " + regulation + " regulation - FortradeR");
        Allure.step("Left click on the support link.");
    ...
    public void checkFooterPrivacyPolicyLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Footer privacy policy link - " + regulation + " regulation - FortradeR");
        Allure.step("Left click on the footer privacy policy link.");
        fortradeRPage.checkLinksWithLeftClick(fortradeRPage.getFooterPrivacyPolicyLink(regulation), "footer privacy policy link", fortradeRPage.footerPrivacyPolicyUrl(regulation));
    }
    ...
    public void checkFooterPrivacyPolicyLinkWithRightClickTest(String regulation){
        ...
        fortradeRPage.checkLinksWithRightClick(fortradeRPage.getFooterPrivacyPolicyLink(regulation), "footer privacy policy link", fortradeRPage.footerPrivacyPolicyUrl(regulation));
    }

    @Test(description = "TC 7.9 - Verify the left click on info@fortrade.com link opens email window")
    @Parameters({"regulation"})
    public void checkInfoLinkTest(String regulation){
        ScreenshotUtil.setCustomName("Info link - " + regulation + " regulation - FortradeR");
        Allure.step("Check info link.");
        fortradeRPage.checkMailLinks(fortradeRPage.infoLink, "href", TestData.infoUrl);
    }
    ...
    public void checkFscLinkWithLeftClickTest(String regulation){
        ScreenshotUtil.setCustomName("Fsc link - " + regulation + " regulation - FortradeR");
    ...
    public void checkAccountRegulationTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Account regulation in CRM - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        fortradeRPage.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
        readyFortrade.assertURL(TestData.appUrl);
    ...
    public void checkAccountDetailsInCrmTest(String regulation, String countryCode){
        ScreenshotUtil.setCustomName("Account details in CRM - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        fortradeRPage.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
        readyFortrade.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email,TestData.firstName + " " + TestData.lastName,regulation);
    ...
    public void checkTagsInCrmTest(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Marketing tags - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        ...
        fortradeRPage.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation),
    ...
    public void checkLinkIDPCWindows(String regulation,String countryCode){
        ScreenshotUtil.setCustomName("Link ID tag contains the 'PC_windows' value - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl);
        fortradeRPage.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
    ...
    public void emailIsReceived(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Email is received successfully - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
    ...
    public void iDidntReceiveTheCodeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("I didn't received the code link - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=sms-age-annual-saving-knowledge-plang:all");
        fortradeRPage.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
    ...
    public void wrongCodeCannotBeSubmittedTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Wrong code cannot be submitted - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=sms-age-annual-saving-knowledge-plang:all");
        fortradeRPage.fillTheFormOnTheSecondStepWithWrongSmsCode(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation),
                "25_34_age", "15000_50000_annual", "50000_100000_savings", "knowledge_of_trading_all_the_above","lang_EN",
                "1", "1", "1", "1");
    ...
    public void editPencilButtonTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Edit pencil button redirects to the first step - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=sms-age-annual-saving-knowledge-plang:all");
        fortradeRPage.goToSecondStep(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
    ...
    public void redirectionToTheSecondStepAgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (age) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
    ...
    public void registeredAgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (age) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "25_34_age", SecondStepField.AGE);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForAgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (age) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        fortradeRPage.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "25_34_age", "-99", SecondStepField.AGE);
        fortradeRPage.assertSecondStepErrorMessage(SecondStepField.AGE);
    }
    ...
    public void ageParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (age) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "25_34_age", SecondStepField.AGE);
    ...
    public void smsVerificationAgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (age) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "25_34_age", SecondStepField.AGE);
    ...
    public void redirectionToTheSecondStepAnnualTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (annual) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
    ...
    public void registeredAnnualParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (annual) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "15000_50000_annual", SecondStepField.ANNUAL);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForAnnualParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (annual) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        fortradeRPage.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "15000_50000_annual", "-99", SecondStepField.ANNUAL);
        fortradeRPage.assertSecondStepErrorMessage(SecondStepField.ANNUAL);
    }
    ...
    public void annualParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (annual) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "15000_50000_annual", SecondStepField.ANNUAL);
    ...
    public void smsVerificationAnnualTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (annual) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=annual");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "15000_50000_annual", SecondStepField.ANNUAL);
    ...
    public void redirectionToTheSecondStepSavingTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (saving) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
    ...
    public void registeredSavingParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (saving) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "50000_100000_savings", SecondStepField.SAVING);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForSavingParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (saving) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        fortradeRPage.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "50000_100000_savings", "-99", SecondStepField.SAVING);
        fortradeRPage.assertSecondStepErrorMessage(SecondStepField.SAVING);
    }
    ...
    public void savingParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (saving) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "50000_100000_savings", SecondStepField.SAVING);
    ...
    public void smsVerificationSavingTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (saving) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=saving");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "50000_100000_savings", SecondStepField.SAVING);
    ...
    public void redirectionToTheSecondStepKnowledgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (knowledge) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
    ...
    public void registeredKnowledgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (knowledge) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", SecondStepField.KNOWLEDGE);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForKnowledgeParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (knowledge) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        fortradeRPage.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", "-99", SecondStepField.KNOWLEDGE);
        fortradeRPage.assertSecondStepErrorMessage(SecondStepField.KNOWLEDGE);
    }
    ...
    public void knowledgeParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (knowledge) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", SecondStepField.KNOWLEDGE);
    ...
    public void smsVerificationKnowledgeTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (knowledge) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=knowledge");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "knowledge_of_trading_all_the_above", SecondStepField.KNOWLEDGE);
    ...
    public void redirectionToTheSecondStepLanguageTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is redirected to the second step (language) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
    ...
    public void registeredLanguageParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("User is registered (language) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "lang_EN", SecondStepField.LANGUAGE);
        readyFortrade.assertURL(TestData.appUrl);
    }
    ...
    public void errorMessageForLanguageParameterTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Error message (language) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        fortradeRPage.wrongDataSecondStep(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "lang_EN", "-99", SecondStepField.LANGUAGE);
        fortradeRPage.assertSecondStepErrorMessage(SecondStepField.LANGUAGE);
    }
    ...
    public void languageParameterCRMTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("Parameter in the CRM (language) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation), "lang_EN", SecondStepField.LANGUAGE);
    ...
    public void smsVerificationLanguageTest(String regulation, String countryCode) {
        ScreenshotUtil.setCustomName("SMS field in the CRM (language) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=plang:all");
        fortradeRPage.registerDemoAccountWithParameter(TestData.firstName,TestData.lastName,email,countryCode, fortradeRPage.selectPhoneNumber(regulation), "lang_EN", SecondStepField.LANGUAGE);
    ...
    public void nonValidParameterInTheUrlTest(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Demo account is successfully registered with wrong parameters in the URL - " + regulation + " regulation - FortradeR");
    ...
    public void noDataOnTheSecondStepTest(String regulation,String countryCode) {
        ScreenshotUtil.setCustomName("Error messages (all parameters) - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl(baseUrl + "&fts=age-annual-saving-knowledge-plang:all");
        fortradeRPage.fillTheFormOnTheSecondStepWithWrongData(TestData.firstName, TestData.lastName, email, countryCode, fortradeRPage.selectPhoneNumber(regulation), "25_34_age", "15000_50000_annual", "50000_100000_savings",
                "knowledge_of_trading_all_the_above", "lang_EN");
        fortradeRPage.assertSecondStepErrorMessage(SecondStepField.ALL);
    }
    ...
    public void dummyLeadRegistration(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Dummy - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        ...
        fortradeRPage.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
                fortradeRPage.selectPhoneNumber(regulation), "25_34_age", "50000_100000_annual", "50000_100000_savings",
                "knowledge_of_trading_all_the_above","lang_EN");
        readyFortrade.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email,TestData.fullName,regulation);
    ...
    public void dummy_Lead_Registration(String regulation,String countryCode) throws InterruptedException {
        ...
        fortradeRPage.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
                fortradeRPage.selectPhoneNumber(regulation), "25_34_age", "15000_50000_annual", "50000_100000_savings",
                "knowledge_of_trading_all_the_above","lang_EN");
        readyFortrade.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email,TestData.fullName,regulation);
        crmPage.checkCustomTag("Dummy");
    ...
    public void invalidLeadRegistration(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom tag - Invalid - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        ...
        fortradeRPage.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
                fortradeRPage.selectPhoneNumber(regulation), "45_54_age", "15000_50000_annual", "100000_250000_savings",
    ...
    public void emptyLeadRegistration(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Empty - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
    ...
    public void deviceIsSameAsParameter(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Dummy - device - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void nonValidParameterSyntax(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Invalid - device - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void deviceIsNotSameAsParameter(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - Empty - device - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void deviceParameterContainsNonValidValue(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("Custom Tag - non valid device value - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkingTheCustomTag(String regulation,String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 20-3-Custom Tag is empty - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        openUrl(baseUrl + "&fts=age-annual-saving-knowledge-plang:all");
        fortradeRPage.registerDemoAccountWithParameters(TestData.firstName,TestData.lastName,email,countryCode,
    ...
    public void checkLanguageFieldContainsExpectedValue(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Language field in the CRM contains expected (FR) value - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String expectedLanguage = fortradeRPage.selectExpectedLanguage(regulation);
    ...
    public void checkLanguageFieldContainsDefaultValue(String regulation,String countryCode) throws IOException, AWTException {
        ScreenshotUtil.setCustomName("Language field in the CRM contains default (EN) value - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void dummypParameter(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 23-1-Custom tag-DummyP value - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void dummyParameter(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 23-2-Custom tag - Dummy value - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void parameterDummy(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 23-3-Custom tag - Dummy value - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        String os = System.getProperty("os.name").toLowerCase();
        if(os.contains("win")){
    ...
    public void customTagContainsDummy(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-1-Custom tag field - dummy - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void customTagContainsDummyValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-2-Custom tag field - dummy - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void customTagContainsEmpty(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-3-Custom tag field - empty - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void customTagContainsEmptyValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 24-4-Custom tag field - empty - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkNumberIplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-1-Link Id tag field - {number}_IPL - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        ...
        readyFortrade.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email,TestData.fullName,regulation);
        crmPage.checkLinkIdValue("0.0952@1500");
    }
    ...
    public void checkMissingTag1IplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-2-Link Id tag field - missingTag1_IPL - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkMissingCidIplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-3-Link Id tag field - missingCID_IPL - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkDivByZeroIplValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 25-4-Link Id tag field - divByZero_IPL - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
    ...
    public void checkNoneUsdValue(String regulation, String countryCode) throws InterruptedException {
        ScreenshotUtil.setCustomName("TC 26-2-Link Id tag field - None-usd - " + regulation + " regulation - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("redirected to the url");
        openUrl(baseUrl);
        fortradeRPage.registerDemoAccount(TestData.firstName,TestData.lastName,email,countryCode,fortradeRPage.selectPhoneNumber(regulation));
