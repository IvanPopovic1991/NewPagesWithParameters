...
public class PremiumForexCA extends BaseTest {
    ...
    @Test(description = "13.1. Verify the user is redirected to the 2nd step - age verification window")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "13.2. Verify the 2nd step - age verification window is successfully completed and submitted")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "13.3. Verify the 2nd step - age verification window cannot be submitted if it's not completed")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "13.4. Verify the age value is displayed correctly in the Link ID field in the CRM")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "13.5. Vefiry that SMS verification field has emtpty (-) value")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "14.1. Verify the user is redirected to the 2nd step - annual verification window")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "14.2. Verify the 2nd step - annual income verification window is successfully completed and submitted")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "14.3. Verify the 2nd step - annual income verification window cannot be submitted if it's not completed")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "14.4. Verify the annual value is displayed correctly in the Link ID field in the CRM")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "14.5. Verify that SMS verification field has emtpty (-) value")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "15.1. Verify the user is redirected to the 2nd step - saving and investments verification window")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "15.2. Verify the 2nd step -  value of saving and investments verification window is successfully completed and submitted")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "15.3. Verify the 2nd step - value of saving and investments verification window cannot be submitted if it's not completed")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "15.4. Verify the saving value is displayed correctly in the Link ID field in the CRM")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "15.5. Verify that SMS verification field has emtpty (-) value")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "16.1. Verify the user is redirected to the 2nd step - knowledge of trading verification window")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "16.2. Verify the 2nd step -  knowledge of trading verification window is successfully completed and submitted")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "16.3. Verify the 2nd step - knowledge of trading verification window cannot be submitted if it's not completed")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "16.4. Verify the knowledge of trading value is displayed correctly in the Link ID field in the CRM")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "16.5. Vefiry that SMS verification field has emtpty (-) value")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "17.1. Verify the user is redirected to the 2nd step - language verification window")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "17.2. Verify the 2nd step -  desired communication language verification window is successfully completed and submitted")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "17.3. Verify the 2nd step - desired communication language verification window cannot be submitted if it's not completed")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "17.4. Verify the desired communication language value is displayed correctly in the Link ID field in the CRM")
    @Parameters({"regulation","countryCode"})
    ...
    @Test(description = "17.5. Verify that SMS verification field has emtpty (-) value")
    @Parameters({"regulation","countryCode"})
