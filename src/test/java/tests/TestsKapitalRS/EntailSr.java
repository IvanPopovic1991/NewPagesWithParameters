...
import core.pages.KapitalRSPage;
...
public class EntailSr extends BaseTest {
    ...
    public void alreadyRegisteredEmailAddressTest(String countryCode) {
        ...
        Allure.step("Redirected to https://dlp.kapitalrs.com/lps/entail/sr?croforce_preview=6a60a5642a5b0e7eed0581d3&croforce_preview_variant=Xn7YB7ZR5N");
