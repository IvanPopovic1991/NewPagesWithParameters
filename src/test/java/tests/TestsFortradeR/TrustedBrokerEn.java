...
public class TrustedBrokerEn extends BaseTest {
    ...
    public void logoClickabilityTest() {
        ...
        fortradeRPage.assertURL("https://dlp.fortrader.com/lps/trusted-broker/en");
    }
    ...
    public void alreadyRegisteredEmailAddressTest(String countryCode) {
        ...
        Allure.step("Redirected to https://dlp.fortrader.com/lps/trusted-broker/en");
    ...
    public void checkTagsInCrmTest(String countryCode) {
        ScreenshotUtil.setCustomName("Marketing tags FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=age-annual-saving-knowledge-plang:all&tg=ivanA" +
    ...
    public void emailIsReceived(String countryCode) {
        ScreenshotUtil.setCustomName("Email is received successfully - FortradeR");
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        readyFortrade.assertURL(TestData.appUrl);
        readyFortrade.clickUsePassBtn();
    ...
    public void iDidntReceiveTheCodeTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=sms");
    ...
    public void wrongCodeCannotBeSubmittedTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=sms-age-annual-saving-knowledge-plang:all");
    ...
    public void redirectionToTheSecondStepAgeTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=age");
        fortradeRPage.goToSecondStep(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
    ...
    public void redirectionToTheSecondStepAnnualTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=annual");
        fortradeRPage.goToSecondStep(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
    ...
    public void redirectionToTheSecondStepSavingTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=saving");
        fortradeRPage.goToSecondStep(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
    ...
    public void redirectionToTheSecondStepKnowledgeTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=knowledge");
        fortradeRPage.goToSecondStep(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
    ...
    public void redirectionToTheSecondStepLanguageTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=plang:all");
        fortradeRPage.goToSecondStep(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
    ...
    public void nonValidParameterInTheUrlTest(String countryCode) throws IOException, AWTException {
        ...
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=testq-testa");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, TestData.generateEmail(), countryCode, TestData.generatePhoneNumber());
        readyFortrade.assertURL("https://ready.fortrade.com/");
        readyFortrade.clickUsePassBtn();
        readyFortrade.clickMenuBtn();
    ...
    public void noDataOnTheSecondStepTest(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=age-annual-saving-knowledge-plang:all");
    ...
    public void dummyLeadRegistration(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the page url");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=annual-saving-knowledge-age-plang:all&" +
    ...
    public void deviceIsSameAsParameter(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(1)");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(1)");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
        crmPage.checkCustomTag("Dummy");
    ...
    public void nonValidParameterSyntax(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device(1)");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device(1)");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
        crmPage.checkCustomTag("Invalid");
    ...
    public void deviceIsNotSameAsParameter(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(4)");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(4)");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
        crmPage.checkCustomTag("");
    ...
    public void deviceParameterContainsNonValidValue(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(0)");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(0)");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
        crmPage.checkCustomTag("Invalid");
    ...
    public void checkingTheCustomTag(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en?fts=age-annual-saving-knowledge-plang:all");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?fts=age-annual-saving-knowledge-plang:all");
        fortradeRPage.registerDemoAccountWithParameters(TestData.firstName, TestData.lastName, email, countryCode,
                TestData.generatePhoneNumber(), "45-54", "$15,000-$50,000", "$100,000-$250,000",
                "All the above", "English");
    ...
    public void checkLanguageFieldContainsExpectedValue(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?userLang=FR");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        readyFortrade.assertURL(TestData.appUrl);
    ...
    public void checkLanguageFieldContainsDefaultValue(String countryCode) {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?userLang=FRA");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        readyFortrade.assertURL(TestData.appUrl);
    ...
    public void dummypParameter(String countryCode) throws InterruptedException {
        ...
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(1)&dummyP=1");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
    ...
    public void dummyParameter(String countryCode) throws InterruptedException {
        ...
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?ftsquery=device-equals(1)&dummyP=0");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
        crmPage.checkCustomTag("Dummy");
    ...
    public void customTagContainsDummy(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en?Dummy=true");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?Dummy=true");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
        crmPage.checkCustomTag("Dummy");
    ...
    public void customTagContainsDummyValue(String countryCode) throws InterruptedException {
        ...
        String email = TestData.generateEmail();
        Allure.step("Redirected to the https://dlp.fortrader.com/lps/trusted-broker/en?Dummy=1");
        openUrl("https://dlp.fortrader.com/lps/trusted-broker/en?Dummy=1");
        fortradeRPage.registerDemoAccount(TestData.firstName, TestData.lastName, email, countryCode, TestData.generatePhoneNumber());
        fortradeRPage.assertURL(TestData.appUrl);
        crmPage.checkCrmData(email, TestData.fullName, "FSC");
        crmPage.checkCustomTag("Dummy");
